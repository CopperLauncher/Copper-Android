...
/**
 * Dedicated "Launcher appearance" settings screen. Used to live as a category
 * inside Experimental Settings (alongside force-landscape) — moved out to its
 * own top-level screen since it's everyday, non-experimental configuration.
 */
